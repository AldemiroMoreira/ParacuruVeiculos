                ...
                <div className="flex">
                    ...
                    <div className="ml-3">
                        <p className="text-sm text-blue-700">
                            <span className="font-bold">Dica de Economia:</span> Renove seus anúncios antes do vencimento e ganhe <span className="font-bold">20% de desconto</span>! A nova validade será somada à data atual.
                        </p>
                        <p className="text-sm text-blue-700 mt-1">
                            <span className="font-bold">Vendeu rápido?</span> Se vender antes do prazo, você pode editar o anúncio para outro veículo e aproveitar o tempo restante!
                        </p>
                    </div>
                </div>
            </div>
